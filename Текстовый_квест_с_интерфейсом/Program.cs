...
namespace Текстовый_квест_с_интерфейсом
{
    internal static class Program
    {
        ...
        static void Main()
        {
            ...
            NPC Vadim = new NPC { X_ = 1, Y_ = 0, Name_ = "Вадим", item_ = Zapisi, Answer_ = 1, Advice_ = "Я забыл свой учебник на скамейке, принеси пожалуйста",F_Number_=0, Index = "4" };
            ...
            NPC Zina = new NPC { X_ = 2, Y_ = 0, Name_ = "Зинаида", Answer_ = 4, item_ = Bilet, Advice_ = "Иногда студенческий билет важнее паспорта", F_Number_ = 1, Index = "4" };
            ...
            NPC Cat = new NPC { X_ = 1, Y_ = 1, Name_ = "Кот", Answer_ = 3, item_ = Ksiva, Advice_ = "Мяу", F_Number_ = 2, Index = "4" };
            ...
            NPC Kassir = new NPC { X_ = 0, Y_ = 1, Name_ = "Ашот", Answer_ = 2, item_ = Pelmeni, Advice_ = "Ты никуда не опаздываешь?", F_Number_ = 3, Index = "4" };
            ...
            NPC Ohrannik = new NPC { X_ = 0, Y_ = 2, Name_ = "Охранник", Answer_ = 1, item_ = Spisok, Advice_ = "Ты ничего не забыл в своей комнате?", F_Number_ = 4, Index = "4" };
